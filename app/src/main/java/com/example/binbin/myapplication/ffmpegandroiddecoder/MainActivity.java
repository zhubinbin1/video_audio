package com.example.binbin.myapplication.ffmpegandroiddecoder;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    static {
        System.loadLibrary("ffmpeg_decode");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_ffmpeg_decode);
    ...
    private void startDecode() {
        ...
        String inputurl=Environment.getExternalStorageDirectory()
                .getAbsolutePath() + "/pauseRecordDemo/video"+"/"+editText1.getText().toString();

        String outputurl=Environment.getExternalStorageDirectory()
                .getAbsolutePath() + "/pauseRecordDemo/video"+"/"+editText2.getText().toString();
