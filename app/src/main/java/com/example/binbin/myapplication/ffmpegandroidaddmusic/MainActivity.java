package com.example.binbin.myapplication.ffmpegandroidaddmusic;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_add_music);
    ...
    private void startDecode() {
        ...
        String folderurl= "/storage/emulated/0/pauseRecordDemo/video";
