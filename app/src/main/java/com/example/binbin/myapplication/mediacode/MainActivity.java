package com.example.binbin.myapplication.mediacode;
...
import com.example.binbin.myapplication.mediacode.player.IPlayerCallBack;
import com.example.binbin.myapplication.mediacode.player.PlayerView;
import com.example.binbin.myapplication.mediacode.player.VideoPlayer;
...
public class MainActivity extends AppCompatActivity implements IPlayerCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_mediacode);
