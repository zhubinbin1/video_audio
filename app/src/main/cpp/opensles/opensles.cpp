...
Java_com_example_binbin_myapplication_ffmpegopensles_MusicPlay_play(JNIEnv *env, jobject instance) {
        createEngine();
        createMixVolume();
        createPlayer();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_binbin_myapplication_ffmpegopensles_MusicPlay_stop(JNIEnv *env, jobject instance) {
    realseResource();
}